...
<div class="border-round-bg">
    <div class="row mb-3">
        <div class="col-lg-9">
            ...
            <?php endif ?>
            <p class="fs-4"><strong><i class="fa-solid fa-address-card"></i> เลขประจำตัวประชาชน: </strong><?= $patient['personal_id_number'] ?> | <strong>ศาสนา: </strong><?= $patient['religion'] ?></p>
            <p class="fs-4"><strong><i class="fa-solid fa-user"></i> ชื่อ-สกุล: </strong> <?= $patient['full_name'] ?> | <strong>เพศ: </strong> <?= $patient['gender'] ?></p>
            <p class="fs-4"><strong><i class="fa-solid fa-cake-candles"></i> วัน/เดือน/ปีเกิด: </strong><?= date('d/m/Y', strtotime($patient['birthdate'])) ?> | <strong>อายุ: </strong><?= $age ?> ปี</p>
            <hr width="60%">
            <h2><i class="fa-solid fa-wheelchair"></i> ความพิการ</h2>      
            <ul>
                <?php
            ...
            <hr width="60%">
            <p class="fs-4"><strong><i class="fa-solid fa-mobile-screen-button"></i> เบอร์โทรศัพท์: </strong><?= $patient['phone_number'] ?></p>
            <p class="fs-4"><strong><i class="fa-solid fa-envelope"></i> อีเมล: </strong><?= $patient['email'] ?></p>
            <p class="fs-4"><strong><i class="fa-solid fa-restroom"></i> สถานะสมรส: </strong><?= $patient['marriage_status'] ?> | <strong>จำนวนบุตร: </strong><?= $patient['number_of_children'] ?></p>
    ...
    <h4 class="display-6"><i class="fa-solid fa-clipboard-list"></i> ประวัติการเข้ารับบริการ </h4>
    <hr>
