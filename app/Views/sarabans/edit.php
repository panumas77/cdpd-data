...
<div class="row mb-3">
    ...
    <div class="col-lg-2">
        ...
        <input type="text" name="birthdate" id="birthdate" class="form-control datepicker" value="<?= $patient['birthdate'] ?>" placeholder="dd-mm-yyyy" required>
 <div class="invalid-feedback">
                กรุณากรอก วันเกิด.
            </div>
...
<div class="mt-4">
    ...
    <a href="/patients" class="btn btn-secondary">ยกเลิก</a>
</div>
<?= form_close() ?>
<br>
<br>

<img src="<?= base_url($patient['profile_picture']) ?>" alt="<?=$patient['full_name'] ?>" class="patient-image img-thumbnail" width=100% >
<script>
